                    ...
                    <form className="form" onSubmit={this.onSubmit}>
                        <div className="row">
                            <div className="col-sm-12">
                                <input type="text" className="form-control rounded-0 py-2" name="username" value="agungjati94@gmail.com" placeholder="Username" />
                            </div>
                        </div>
                        <div className="row mt-3">
                            <div className="col-sm-12">
                                <input type="password" className="form-control rounded-0 py-2" value="password" name="password" placeholder="Password" />
                            </div>
                        </div>
